...
type ScalerSpec struct {
	...
	Deploys  []NamedSpace `json:"deploys"`
}
...
// +kubebuilder:printccolumn:name="Status",type="string",JSONPath=".status.status"
// +kubebuilder:printccolumn:name="Age",type="date",JSONPath=".metadata.creationTimestamp"
